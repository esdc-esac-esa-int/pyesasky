...
export class ESASkyJSModel extends DOMWidgetModel {
    ...
    defaults() {
        return Object.assign(Object.assign({}, super.defaults()), { _model_name: "ESASkyJSModel", _view_name: "ESASkyJSView", _model_module: "pyesasky", _view_module: "pyesasky", view_module_ids: [], _view_module_version: '1.8.1', _model_module_version: '1.8.1' });
    }
}
    ...
    handle_custom_message(msg) {
        ...
        if (this.oldMsgIdToFront != msg.msgId) {
            if (this.modelId == currActiveId) {
                ...
                let iFrameElement = document.getElementById(this.modelId);
