	...
	handle_custom_message: function (msg) {
		...
		switch (msg['event']) {
			...
			case 'addJwstWithCoordinates':
				...
				console.log(msg);
				return document.getElementById('esaskyFrame').contentWindow.ESASkyAPI.addJwstWithCoordinatesAPI(msg['instrument'],msg['detector'],msg['showAllInstruments'],msg['ra'], msg['dec'], msg['rotation']);

			case 'closeJwstPanel':
				console.log('closeJwstPanel event captured!');
				console.log(msg);
				return document.getElementById('esaskyFrame').contentWindow.ESASkyAPI.closeJwstPanelAPI();

			case 'openJwstPanel':
				console.log('openJwstPanel event captured!');
				console.log(msg);
				return document.getElementById('esaskyFrame').contentWindow.ESASkyAPI.openJwstPanelAPI();
				
			case 'clearJwstAll':
				console.log('clearJwst event captured!');
				console.log(msg);
				return document.getElementById('esaskyFrame').contentWindow.ESASkyAPI.clearJwstAPI();
