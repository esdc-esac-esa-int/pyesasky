...
var __gwtModuleFunction = $wnd.esaskyweb_V3_1_1_B60;
...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.esaskyweb_V3_1_1_B60=");
    idx += (13 + "esaskyweb_V3_1_1_B60".length);  // 
  }
  if (idx >= 0) {
...
//# sourceURL=esaskyweb_V3_1_1_B60-0.js
