...
var __gwtModuleFunction = $wnd.esaskyweb_V3_1_B42;
...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.esaskyweb_V3_1_B42=");
    idx += (13 + "esaskyweb_V3_1_B42".length);  // 
  }
  if (idx >= 0) {
...
//# sourceURL=esaskyweb_V3_1_B42-0.js
