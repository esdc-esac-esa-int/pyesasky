...
var __gwtModuleFunction = $wnd.esaskyweb_V3_1_1_B51;
...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.esaskyweb_V3_1_1_B51=");
    idx += (13 + "esaskyweb_V3_1_1_B51".length);  // 
  }
  if (idx >= 0) {
...
//# sourceURL=esaskyweb_V3_1_1_B51-0.js
