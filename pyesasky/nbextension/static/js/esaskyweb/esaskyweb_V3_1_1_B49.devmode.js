...
var __gwtModuleFunction = $wnd.esaskyweb_V3_1_1_B49;
...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.esaskyweb_V3_1_1_B49=");
    idx += (13 + "esaskyweb_V3_1_1_B49".length);  // 
  }
  if (idx >= 0) {
...
//# sourceURL=esaskyweb_V3_1_1_B49-0.js
