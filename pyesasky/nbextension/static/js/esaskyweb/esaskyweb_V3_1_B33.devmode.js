...
var __gwtModuleFunction = $wnd.esaskyweb_V3_1_B33;
...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.esaskyweb_V3_1_B33=");
    idx += (13 + "esaskyweb_V3_1_B33".length);  // 
  }
  if (idx >= 0) {
...
//# sourceURL=esaskyweb_V3_1_B33-0.js
