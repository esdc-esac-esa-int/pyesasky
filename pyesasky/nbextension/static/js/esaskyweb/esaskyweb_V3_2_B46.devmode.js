...
var __gwtModuleFunction = $wnd.esaskyweb_V3_2_B46;
...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.esaskyweb_V3_2_B46=");
    idx += (13 + "esaskyweb_V3_2_B46".length);  // 
  }
  if (idx >= 0) {
...
//# sourceURL=esaskyweb_V3_2_B46-0.js
